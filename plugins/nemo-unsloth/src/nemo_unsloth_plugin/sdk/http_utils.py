...
"""Shared HTTP helpers for Unsloth customization SDK resources."""
...
_JOBS_COLLECTION = "v2/workspaces/{workspace}/unsloth/jobs"
...
def jobs_collection_url(platform: PlatformClient, workspace: str | None = None) -> str:
    """URL for the Unsloth jobs collection in a workspace."""
...
def create_job_payload(spec: UnslothJobInput) -> dict[str, dict[str, Any]]:
    """Serialize an Unsloth job creation request body."""
