...
def smart_parse(text: str) -> dict:
    ...
    # First try: Parse as pure JSON. Only accept JSON objects — valid non-object
    # JSON (bool/number/list/string) would violate the ``-> dict`` contract.
    try:
    ...
    # Second try: Look for a JSON object within text
