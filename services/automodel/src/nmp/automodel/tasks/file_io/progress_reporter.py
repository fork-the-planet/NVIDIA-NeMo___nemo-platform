...
from nmp.automodel.app.jobs.file_io.schemas import ProgressReportError
from nmp.automodel.tasks.file_io.utils import sdk_error_handler
...
class JobsServiceProgressReporter:
    ...
    def create_progress_reporter(sdk: NeMoPlatform, job_ctx: NMPJobContext) -> ProgressReporter:
        """Create JobsServiceProgressReporter when jobs_url is set, else NoOpProgressReporter."""
        if job_ctx.jobs_url:
