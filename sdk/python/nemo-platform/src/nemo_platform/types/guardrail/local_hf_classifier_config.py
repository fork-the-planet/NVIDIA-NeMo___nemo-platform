...
__all__ = ["LocalHfClassifierConfig"]


class LocalHfClassifierConfig(BaseModel):
    ...
    engine: Optional[Literal["local"]] = None
    ...
    task: Optional[Literal["text-classification", "token-classification"]] = None
