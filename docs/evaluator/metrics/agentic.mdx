...
```python
from nemo_evaluator_sdk import InferenceParams, Model
...
metric = TopicAdherenceMetric(
    ...
    inference=InferenceParams(temperature=0, response_format={"type": "json_object"}),
)
...
```python
from nemo_evaluator_sdk import InferenceParams, RunConfig, Model
from nemo_evaluator_sdk.metrics.ragas import TopicAdherenceMetric
